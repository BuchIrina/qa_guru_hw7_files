...
import com.buchneva.model.Teacher;
...
public class FileParseTest {
    ...
    void pdfTest() throws Exception {
        ...
        assertThat(pdf.producer).contains("Sam Brannen");
    }

    @Test
    void xlsTest() throws Exception {
        InputStream is = cl.getResourceAsStream("test-report-excel-example.xlsx");
        XLS xls = new XLS(is);
        assertThat(xls.excel.getSheetAt(0).getRow(2).getCell(0).getStringCellValue())
                .isEqualTo("Windows");
    }
    ...
    void zipTest() throws Exception {
        InputStream is = cl.getResourceAsStream("test-report-excel-example.zip");
